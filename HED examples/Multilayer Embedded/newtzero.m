...
defaults = {1,100,1e-15};% Initial guess, max iterations, tolerance.
...
LGS = logspace(0,1,220); % Can be altered for wider range or denser search.
LNS = 0:1/50:18/19;  % Search very close to initial guess too.
...
% warning off % WILL BE RESET AT THE END OF WHILE LOOP. 
