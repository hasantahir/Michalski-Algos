...
kz1 = @(kp) (sqrtbr(k1 ^2 - kp .^2, -pi/2));

kz2 = @(kp) (sqrt(k2 ^2 - kp .^2));

kz3 = @(kp) (sqrtbr(k3 ^2 - kp .^2, -pi/2));

% kz1 = @(kp) (sqrt(k1 ^2 - k1^2 - kp .^2));
% 
...
% S = (ep1 + ep3)/2;
% 
% kz1 = @(z) exp(eta*z) + R *exp( -eta*z);
% kz3 = @(z) exp(eta*z) - R *exp( -eta*z);
